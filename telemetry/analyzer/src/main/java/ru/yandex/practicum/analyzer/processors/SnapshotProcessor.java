...
import ru.yandex.practicum.analyzer.handlers.SnapshotBuilderHandler;
...
public class SnapshotProcessor {
    ...
    private final SnapshotBuilderHandler snapshotBuilderHandler;
        ...
        try {
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, SensorsSnapshotAvro> record : records) {
                    ...
                    snapshotBuilderHandler.buildSnapshot(sensorsSnapshot);
                }
                consumer.commitSync();
            }
